App.directive('slider', ['$parse', '$timeout', function ($parse, $timeout) {
        return {
            restrict: 'AE',
            replace: true,
            ...
            link: function ($scope, element, attrs, ngModelCtrl) {
                jQuery.fn.slider.Constructor.prototype.disable = function () {
                    this.picker.off();
                };
                ...
                if (options.range && !options.value) {
                    options.value = [0,0]; // This is needed, because of value defined at jQuery.fn.slider.defaults - default value 5 prevents creating range slider
                }

                var slider = jQuery(element[0]).slider(options);
